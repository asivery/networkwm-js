...
export class SonyVendorNWJSUSMCDriver extends SonyVendorUSMCDriver {
    ...
    async writeAuthenticationStage3Info(hostMac: Uint8Array) {
        ...
        finalBuffer.set(
            [
                0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0xf0, 0x5c, 0xb7, 0xfe,
                0xde, 0x3c, 0x94, 0x01, 0x78, 0x4a, 0x71, 0x8d, 0x9f, 0xf7, 0xf4, 0xb1,
            ],
            10
        );
